...
class leaves_allocation(models.TransientModel):
    ...
    def get_leave_type(self):
        ...
        leave_types = {
            ...
            'maternity_leave': self.env.ref('amcl_hr_leaves_management.holiday_status_maternity'),
            'marrige_leave': self.env.ref('amcl_hr_leaves_management.holiday_status_marriage'),
            'compassionate_leave': self.env.ref('amcl_hr_leaves_management.holiday_status_compassionate'),
            'paternity_leave': self.env.ref('amcl_hr_leaves_management.holiday_status_paternity'),
            'hajj_leave': self.env.ref('amcl_hr_leaves_management.holiday_status_hajj'),
            'secondment_leave': self.env.ref('amcl_hr_leaves_management.holiday_status_secondment'),
        }
        return leave_types
    ...
    def onchange_target(self):
        ...
        #     domain.append(('joining_date', '<', duration.strftime("%Y-%m-%d")))
        #
